...
beacon_attack(){
    ...
    clear
    banner
    echo -e "\n${CYAN}[*]${RESET} Ataque Beacon Flooding en curso a la red ${YELLOW}${selected_essid}${RESET} en el canal ${YELLOW}${selected_channel}${RESET}\n"
    echo -e "\n${YELLOW}[*] Ctrl + C para parar${RESET}"
